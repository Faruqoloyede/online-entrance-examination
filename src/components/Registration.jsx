            ...
            <div className='xl:max-w-[1280px] w-full'>
                <div className='flex items-center justify-end sm:px-16 px-6 py-16'>
                    <form className='bg-white w-[50%] px-4 py-12'>
                        ...
                        <div className='mb-5'>
                            <input type="text" placeholder='fullname' name='email' className='border border-[#CCCCCC] outline-[#91BBDD] px-4 py-2 rounded-sm w-full placeholder:text-[18px]' />
                        </div>
                        <div className='mb-5'>
                        ...
                        <div className='mb-5'>
                            <input type="number" name='number' placeholder='contact' className='border border-[#CCCCCC] outline-[#91BBDD] px-4 py-2 rounded-sm w-full placeholder:text-[18px]' />
                        </div>
                        <div className='mb-5'>
